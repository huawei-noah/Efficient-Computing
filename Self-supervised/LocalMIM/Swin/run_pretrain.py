...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='mim_swin_base_patch4_win7', type=str, metavar='MODEL', help='Name of model to train')
    parser.add_argument('--input_size', default=224, type=int, help='images input size')
    parser.add_argument('--mask_ratio', default=0.75, type=float, help='Masking ratio (percentage of removed patches).')
    parser.add_argument('--target', default='HOG', type=str, choices=['HOG', 'Pixel'], help='HOG or Pixel')
...
def main(args):
    ...
    # define the model
    if args.model in models_mim.__dict__:
        model = models_mim.__dict__[args.model](target=args.target, hog_nbins=args.hog_nbins, hog_bias=args.hog_bias, norm_pix_loss=args.norm_pix_loss)
    else:
