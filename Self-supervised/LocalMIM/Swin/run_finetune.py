...
def get_args():
    ...
    parser.add_argument('--min_lr', type=float, default=2.5e-7, help='lower lr bound for cyclic schedulers that hit 0')
...
def main(args):
    ...
    if args.finetune and not args.eval:
        ...
        checkpoint_model = {k[8:]: v for k, v in checkpoint_model.items() if 'encoder.' in k}
    ...
    param_groups = lrd.param_groups_lrd(model_without_ddp, args.lr, args.weight_decay, args.layer_decay, model_without_ddp.no_weight_decay())
