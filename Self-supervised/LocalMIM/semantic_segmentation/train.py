...
from backbone import vit, swin


def parse_args():
    parser = argparse.ArgumentParser(description='Train a segmentor')
    parser.add_argument('--config', default='./', help='train config file path')
    parser.add_argument('--work-dir', default='./output/test', help='the dir to save logs and models')
    ...
    group_gpus.add_argument('--gpus', type=int, help='number of gpus (only applicable to non-distributed training)')
